export enum StorageKey {
  ThemeMode = 'UI_COVERAGE_REPORT_THEME_MODE',
  AgentFilters = 'UI_COVERAGE_REPORT_AGENT_FILTERS',
  AgentSettings = 'UI_COVERAGE_REPORT_AGENT_SETTINGS',
  FrameLayoutSettings = 'UI_COVERAGE_REPORT_FRAME_LAYOUT_SETTINGS',
  ScenarioStepsFilters = 'UI_COVERAGE_REPORT_SCENARIO_STEPS_FILTERS'
}
